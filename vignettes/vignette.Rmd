...
```{r, echo = TRUE, highlight=FALSE, warning=FALSE, message=FALSE, fig.width=12, fig.height=5, dpi=72, cache=TRUE}
myMDSplot(log2)
```
...
```{r, echo = TRUE, highlight=FALSE, warning=FALSE, message=FALSE, fig.width=13, fig.height=400, dpi=72, cache=TRUE}
...
```{r, echo = TRUE, highlight=FALSE, warning=FALSE, message=FALSE, fig.height=5, fig.width=5, cache=TRUE}
myvenndiagram(ttest)
```
...
<div style="height: 470px; overflow: scroll;">
```{r, echo = TRUE, highlight=FALSE, warning=FALSE, message=FALSE, fig.width=40, fig.height=5, dpi=72, cache=TRUE}
...
```{r, echo = TRUE, highlight=FALSE, warning=FALSE, message=FALSE, fig.height=5, fig.width=8, cache=TRUE}
...
<div style="height: 470px; overflow: scroll;">
```{r, echo = TRUE, highlight=FALSE, fig.width=20, fig.height=6, cache=TRUE}
...
You can ask NeXtProt to mine IP, Mass, TMregions, glycosylation site, and subcellular location of the protein of interest.
...
You can also use another function in combination to apply to your column, which works for all above functions:
